            ...
            when (update.message.text) {
                ...
                "Пополнить баланс" -> {
                    sendMessage("На данный момент времени оплата через бота не принимается!\n\n" +
                                "Для активации VPN напишите одному из админов пройдя по кнопкам ниже." ,
                        user.chatId, null, listOf(
                            "Админ-1" to "https://t.me/snitron",
                            "Админ-2" to "https://t.me/kuratz",
                ...
                "Баланс" -> {
                    sendMessage("Вы нам важны не из-за денег!\n\n" +
                                ...
                                "Если вы решили поддержать нас, пишите @snitron. \n\nСпасибо!", user.chatId, listOf(listOf("Меню"))
                    )
                ...
                "/fckingSlaves" -> {
                    sendPhoto("enot.jpg", user.chatId)
                }
                "/asAdminCum" -> {
